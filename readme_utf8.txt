...
2. 利用条件
　本ツールは東京コスモス電機の著作物です。提供されるバイナリ、ソースコード、資料
は TWE (TOCOS WIRELESS ENGINE) シリーズにのみ利用できます。
　本ツールは無保証です。不具合等が発見された場合は東京コスモス電機サポート宛に報
...
5. 制限事項
・東京コスモス電機は、測定結果の正確性を保証するものではありません。
...
　しています。特に記載のないものは、東京コスモス電機が著作権を保有するものとし、
　その派生物を含めTWE(TOCOS Wireless Engine)シリーズでの利用に限定します。
